...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function crearDivVisual(datos) {
    ...
    botonActualizar.className = "boton2";
    botonActualizar.addEventListener("click", function () {
      redirigirAModificarCuenta(datos);
    });

    // Añadir ambos botones al div
    nuevoDiv.appendChild(botonActualizar);
  ...
  function redirigirAModificarCuenta(cuenta) {
    ...
    window.location.href = "../Cuentas financieras/ModificarCuenta.php"; // O .html según tu estructura
  }
